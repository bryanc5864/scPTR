...
invisibility: its gamma sub-clusters had silhouette $= 0.215$ in $\gamma$-space but were
actively anti-clustered in expression space (silhouette $= -0.011$). These invisible states
...
temporally precede expression changes for a significant majority of transition genes during
differentiation (Fig.~\ref{fig:findings}B): 54\% of 1{,}472 transition genes in pancreas
($p < 10^{-57}$) and 78\% of 146 genes in dentate gyrus ($p = 9.9 \times 10^{-13}$),
supporting the hypothesis that post-transcriptional regulation acts as an early signal
